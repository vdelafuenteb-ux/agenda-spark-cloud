...
import { ArrowLeft, Mail, CheckCircle2, AlertTriangle, Target, ListChecks, TrendingUp, TrendingDown, CalendarClock, Bell, Loader2, ChevronDown, ChevronRight, BarChart3, Minus } from 'lucide-react';
